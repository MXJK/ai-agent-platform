...
from ai_agent_platform.api.routes.evals import create_evals_router
...
from ai_agent_platform.api.routes.skill_registry import create_skill_registry_router
from ai_agent_platform.api.routes.memory import create_memory_router, create_retired_memory_router

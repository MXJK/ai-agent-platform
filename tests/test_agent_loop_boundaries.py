...
_EXPECTED_EDGES = {
    ...
    ("merge_evidence", "resolve_change_targets", True),
    ("merge_evidence", "plan_tools", True),
    ("resolve_change_targets", "define_completion_contract", True),
    ("resolve_change_targets", "compose_answer", True),
    ("define_completion_contract", "plan_tools", True),
    ("define_completion_contract", "compose_answer", True),

...
class SettingsTests(unittest.TestCase):
    def test_default_embedding_provider_is_local_for_offline_development(self) -> None:
        ...
        self.assertEqual(settings.agent_plan_max_output_tokens, 8192)
        self.assertEqual(settings.agent_mutation_max_output_tokens, 64000)
        self.assertEqual(settings.agent_final_max_output_tokens, 8192)

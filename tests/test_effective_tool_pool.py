...
class ToolPoolBuilderTests(unittest.TestCase):
    ...
    def test_execution_rechecks_permission_after_display_selection(self) -> None:
        ...
        result = pool.execute(
            ToolCall(name="repo.allowed", arguments={}),
            context=_context(project_denied=("repo.allowed",)),
        )

        self.assertFalse(result.ok)
        self.assertEqual(result.error_code, "permission_denied")
        self.assertEqual(
            result.permission_decision["matched_rule"],
